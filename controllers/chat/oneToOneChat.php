...
if (!empty($_GET) && $_SESSION['userLogin'] == "1") {
    ...
    if ($fromUserID != "" && $toUserID != "") {
        ...
        <div class="row chatHead">
            <div class="col-lg-12">
                <div class="col-lg-9">
                    <div><span class="f-sz-20"><?= $fullName; ?> </span><span style=' margin-left: 25px;'
                                                                              class="fa fa-circle <?= $onlineClass; ?>">&nbsp;<span><?= $online; ?></span></span>
                    </div>
        ...
        <div class="chat-input position-relative">
            ...
            <i class="fa fa-paper-plane-o chatSubmit" onclick="submitChat()" id="submitForChat" aria-hidden="true"
               ajax_call="true"></i>
        </div>
        <div class="row chatFooter">
            <div class="col-lg-12">
                <h4>
                    <span class="point fa fa-paperclip listMenuColor listMenuChat" data-toggle="modal"
                          data-target="#sendAttachmentModalDoc"></span>
                    <span class="point fa fa-picture-o listMenuColor listMenuChat" data-toggle="modal"
                          data-target="#sendAttachmentModalImage"></span>
