    ...
    <tr>
        ...
        <?php } else {
            foreach ($results as $value) { ?>
                <tr>
                    <td>
                        <img class='circle' src="<?= $rootUrlImages.$value['photo_path'] ?>" alt="Contact Photo" height="100" width="100">
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        <a href="#" class="btn colorMainBtn btn-xs" data-toggle="modal" data-target="#editContactModal" onclick="updateContact('<?= $value['id']; ?>','<?= $value['first_name']; ?>','<?= $value['last_name']; ?>','<?= $value['moblie_number']; ?>','<?= $value['email_address']; ?>')">Edit</a>
                        <a href="#" class="btn colorMainBtn btn-xs" onclick="deleteContact('<?= $value['id']; ?>')">Delete</a>
                    </td>
